  ...
  return (
    ...
    <div className='results p-1 mb-8'>
      ...
      <Form className='mt-16 mb-8'>
        <p className='text-lg font-medium mb-16'>Add an Access Card to this property</p>
        <div className="row">
            <div className="col-lg-6 mb-4">
                <label className='mb-2 font-normal text-sm'>Access Card Serial Number</label>
                <Form.Control/>
            </div>
            <div className="col-lg-6 mb-4">
            ...
            <div className={`${CSS.imageUploader} mx-auto p-1`}  style={{marginTop:'3rem'}}>
                <Upload  bodyText={
            ...
            <div>
            <button onClick={(e)=>{e.preventDefault(); setContent(true)}} className='mb-8 mt-8 btn btn-outline-primary'>Add Card</button>            
            </div>
        ...
        <img src={House} style={{border:"3px solid rgb(94 204 94)"}} className='w-36 h-36 rounded-full object-cover' alt="" />
        </div>
        <div className="col-lg-8 mb-4">
            <p className='text-muted'>Name : <span></span></p>
            <p className='text-muted'>Phone Number : <span></span></p>
            <p className='text-muted'>Access Card Serial No. : <span></span></p>
