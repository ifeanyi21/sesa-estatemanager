...
function GroupAccess() {
    const dummyVisitor = [
      ...
      const columns = [
        ...
        { sortable:false,field: 'accessCode', headerName: 'Access Code', width: 120 },
        { sortable:false,field: 'visitorDetails', headerName: 'Visitor Name', width: 150 },
        { sortable:false,field: 'businessName', headerName: 'Business Name', width: 160,},
        ...
        renderCell:(params)=>{
           return <ReportsDropDown params={params} viewUrl={"/reports/business-report/"}/>
        },  
