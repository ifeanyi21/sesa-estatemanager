...
function LandlordDetail() {
  const columnsLandlord = [
    { field: "resCode", headerName: "Res. Code", sortable: false, flex:1 ,minWidth: 250 },
    { field: "name", headerName: "Name", sortable: false, flex:1 ,minWidth: 270 },
    { field: "gender", headerName: "Gender", sortable: false, flex:1 ,minWidth: 250 },
    { field: "number", headerName: "Phone No.", sortable: false, flex:1 ,minWidth: 270 },
    {
      field: "class",
