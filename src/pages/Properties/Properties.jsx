...
function Properties() {
  ...
  const onRowsSelectionHandler = (ids) => {
    const selectedRowsData = ids.map((id) =>
      dummyProperties.find((row) => row.id === id)
    );
      ...
      {dummyProperties.length > 0 ? (
        <div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6 mb-2">
              <div
                className="bg-white p-4 shadow-md rounded overflow-y-auto"
                style={{ height: 277 }}
              >
                ...
                <main className="flex justify-between mb-3">
                  <div className="flex items-baseline">
                    ...
                    <div className="ml-2">- 2 bedroom self Con.</div>
                  </div>
                  <span>30</span>
                </main>
                <main className="flex justify-between mb-3">
                  <div className="flex items-baseline">
                    <DotIcon color={"#5856D6"} />
                    <div className="ml-2">- 3 bedroom self Con.</div>
                  </div>
                  <span>30</span>
                </main>
                <main className="flex justify-between mb-3">
            ...
            <div className="col-lg-12">
              <div className="row items-baseline">
                <div className="col-lg-6 mb-1">
                  <div className="flex items-baseline">
                    <p className="mr-3 w-2/6 mb-0 text-lg font-normal ">
                      Property List
                    </p>
                ...
                <div className="col-lg-6 flex justify-end">
                  {selectedRows.length > 0 && (
                    <button
                      className="mr-2 btn btn-sm btn-danger flex"
