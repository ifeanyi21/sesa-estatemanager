...
export default function Reports() {
  ...
  return (
    <div>
      <AppBar />
      <div
        className={`${CSS.layoutReportContainer} flex justify-between h-full pb-32`}
      >
        <SideBar />
          ...
          <Box sx={{ width: "100%" }}>
            ...
            >
              ...
              >
                ...
                <Tab
                  style={{
                    color: value === 6 ? "black" : "gray",
                    textTransform: "capitalize",
                    marginRight: "29px",
                  }}
                  wrapped
                  label="Security Guard Activity"
                  {...a11yProps(6)}
                />
                <Tab
                  style={{
                    color: value === 7 ? "black" : "gray",
                    textTransform: "capitalize",
                    marginRight: "29px",
                  }}
                  wrapped
