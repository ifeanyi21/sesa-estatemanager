import { DeleteIcon, EditEstateIcon } from "../../../components/SideBar/icons";
    ...
    <div>
      ...
      >
        <Link
          ...
          onClick={handleClose}
          className="no-underline text-inherit flex items-baseline px-3 py-2 text-base"
        >
          <EditEstateIcon />
          <span className="ml-3 text-black">Edit Details</span>{" "}
        </Link>
        <button
          className="no-underline flex items-center text-base px-3 py-2"
          onClick={handleShow}
          style={{
            paddingLeft: 0,
        ...
        >
          <DeleteIcon />
          <span className="ml-4">Delete Payment</span>{" "}
        </button>
      </Menu>
      <DeletePayment show={show} onHide={() => setShow(false)} />
    </div>
  );
}
  ...
  return (
    <>
      <Modal show={show} onHide={onHide}>
        ...
        <Modal.Body>
          Are you sure you want to delete this payment plan? If you delete, it
          will be permanently lost
          <div className="col-lg-12 flex justify-end">
            <div className="w-20 mt-5 mr-3">
              <button onClick={onHide} className="btn border">
                Cancel
              </button>
            </div>
