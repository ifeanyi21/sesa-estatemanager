...
function Status(params) {
  return (
    <div
      className={
        params.row.status === "Paid" ? "text-success" : "text-orange-600"
      }
    >
      {params.row.status}
    </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-md-4 p-3">
            <p className="text-muted mb-3">
              Product Code : <span className="text-black"></span>
            </p>
            <p className="text-muted mb-3">
            ...
            <p className="text-muted mb-3">
              Payment Plan : <span className="text-black"></span>
            </p>
            <p className="text-muted mb-3">
              Amount (Total) : <span className="text-black"></span>
            </p>
          </div>
        ...
        <div className="row">
          <div className="col-lg-12 p-3">
            <div className="col-lg-6">
              ...
              <div className="flex justify-end mb-1 text-sm">₦5,000</div>
              <PaymentProgressBar percent={45} />
              <div className="text-center mt-1 text-sm">₦2,000</div>
            </div>
